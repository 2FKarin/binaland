...
--
-- Host: 127.0.0.1:3307
-- Generation Time: Apr 16, 2025 at 10:56 AM
...
(1, 'Binaland', 'Perumahan Elit', 'Prumahan Esklusif Pasuruan', 'Binaland hadir dengan konsep modern dengan letak yang strategis dan nyaman', NULL, '2025-04-16 13:34:55');
...
--
ALTER TABLE `gambar_fasilitas`
  MODIFY `id_gambar_fasilitas` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `gambar_lokasi`
--
ALTER TABLE `gambar_lokasi`
  MODIFY `id_gambar_lokasi` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `reservasi_lokasi`
  MODIFY `id_reservasi_lokasi` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tipe_rumah`
  MODIFY `id_tipe_rumah` int(11) NOT NULL AUTO_INCREMENT;
